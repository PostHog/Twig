...
import { PowerSaveBlockerService } from "../services/power-save-blocker/service.js";
...
container.bind(MAIN_TOKENS.PowerSaveBlockerService).to(PowerSaveBlockerService);
