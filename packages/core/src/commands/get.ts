...
async function restoreBranch(
  ...
  // Forget any existing local bookmark state (handles "deleted" bookmarks)
  // This is a no-op if the bookmark doesn't exist locally
  await runJJWithMutableConfigVoid(["bookmark", "forget", branchName], cwd);
