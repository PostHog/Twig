...
const STACK_CHECK_WORKFLOW = `# Generated by Twig CLI - https://github.com/posthog/twig
# Blocks stacked PRs until their downstack dependencies are merged
# Only runs for PRs managed by Twig (detected via stack comment marker)
...
/**
 * Get repo info by reading git remote.
 */
